...
const contactInfo:IconItem[] = [
  {icon:MapPin , label:"سمنان،شاهرود،میدان ولایت،بلوار شیرودی قبل از 11 غربی"},
  {icon:Phone , label:"09120812787"},
  ...
  return (
    <footer className="relative mt-55 md:mt-48 bg-primary text-white">
      <div className="absolute left-1/2 top-0  w-full max-w-5xl -translate-x-1/2 -translate-y-1/2 rounded-3xl bg-secondary p-6 text-center shadow-2xl">
        ...
        <a href="https://wa.me/09120812787" className={"bg-primary inline-block mt-4 rounded-xl px-6 py-3 font-semibold text-white transition hover:scale-105 hover:cursor-pointer"}>
         تماس با ما
        </a>
      </div>
